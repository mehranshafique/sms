...
@section('styles')
    ...
    <style>
        ...
        .dt-buttons { display: inline-flex; gap: 10px; margin-bottom: 1rem; }
    </style>
@endsection
        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>{{ __('grade_level.grade_management') }}</h4>
                    <p class="mb-0">{{ __('grade_level.manage_list_subtitle') }}</p>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                @can('grade_level.create')
                <a href="{{ route('grade-levels.create') }}" class="btn btn-primary btn-rounded">
                    ...
                    <div class="card-body p-4">
                        <div class="media ai-icon">
                            ...
                            <div class="media-body">
                                ...
                                <h4 class="mb-0">{{ $primaryGrades }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media ai-icon">
                            ...
                            <div class="media-body">
                                ...
                                <h4 class="mb-0">{{ $secondaryGrades }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body p-4">
                        <div class="media ai-icon">
                            ...
                            <div class="media-body">
                                ...
                                <h4 class="mb-0">{{ $universityGrades }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">{{ __('grade_level.grade_list') }}</h4>
                    </div>
                    <div class="card-body">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const table = $('#gradeTable').DataTable({
            ...
            ordering: true,
            order: [[3, 'asc']], // Order by 'order_index' by default
            columns: [
                @can('grade_level.delete')
