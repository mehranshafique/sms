        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>{{ __('campus.edit_campus') }}</h4>
                    <p class="mb-0">{{ __('campus.update_campus_details') }}</p>
                </div>
            </div>
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('campuses.index') }}">{{ __('campus.campus_list') }}</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('campus.edit_campus') }}</a></li>
                </ol>
            </div>
        </div>

        @include('campuses._form', ['campus' => $campus])
    </div>
</div>
@endsection
