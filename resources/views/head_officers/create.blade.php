        ...
        <div class="row page-titles mx-0">
            <div class="col-sm-6 p-md-0">
                <div class="welcome-text">
                    <h4>{{ __('head_officers.add_header_officer') }}</h4>
            ...
            <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('head_officers.create_new') }}</a></li>
                </ol>
            </div>
        </div>

        @include('head_officers._form')
    </div>
</div>
@endsection
...
<script>
    $(document).ready(function(){
        // FIX: Use 'selectpicker' instead of 'select2' to prevent JS crash
        ...
        $('#officerForm').submit(function(e){
            ...
            $.ajax({
                ...
                error: function(xhr){
                    $btn.prop('disabled', false).text('Save'); // Reset button
