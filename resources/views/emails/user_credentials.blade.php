...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>{{ __('emails.greeting', ['name' => $data['name']]) }}</p>
            
            <p>{{ __('emails.account_created_body', ['school_name' => $data['school_name'], 'role' => $data['role']]) }}</p>
            ...
            <p>
                ...
                {{ $data['school_name'] }} {{ __('emails.team') }}
            </p>
        </div>
        <div class="footer">
            &copy; {{ date('Y') }} {{ $data['school_name'] }}. {{ __('emails.footer_rights') }}
        </div>
    </div>
</body>
</html>