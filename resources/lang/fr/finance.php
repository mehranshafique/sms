...
return [
    ...
    'proportional_allocation' => 'Répartition proportionnelle des frais',
    'proportional_allocation_enable' => 'Activer la répartition proportionnelle',
    'proportional_allocation_help' => 'Décomposez un frais global en composantes (ex. Scolarité, Uniforme, Transport). Chaque paiement est alors réparti entre les composantes selon leur part du total.',
    'proportional_allocation_disabled_notice' => 'La répartition proportionnelle est désactivée pour cette école. Les décompositions existantes continuent de s\'appliquer aux paiements, mais aucune nouvelle ne peut être configurée avant activation dans les paramètres de paiement.',
    'split_into_components' => 'Décomposer ce frais en composantes',
    'component_name' => 'Composante',
    'add_component' => 'Ajouter une composante',
    'share' => 'Part',
    'total' => 'Total',
    'components_must_match_total' => 'Le total des composantes doit être égal au montant du frais.',
    'components_min' => 'Ajoutez au moins :count composantes, ou désactivez la répartition proportionnelle.',
    'components_incomplete' => 'Chaque composante doit avoir un nom et un montant supérieur à zéro.',
    'components_sum_mismatch' => 'Le total des composantes est de :total alors que le frais est de :amount.',
    'unallocated_payment' => 'Paiement non réparti',
    'component_report_title' => 'Rapport par composante de frais',
    'component_report_subtitle' => 'Montant de chaque paiement affecté à chaque composante de frais.',
    'component_breakdown' => 'Détail par composante',
    'no_components_yet' => 'Aucune composante de frais n\'a encore été facturée.',
    'collected_outside_components' => 'Perçu sur des frais sans décomposition',
    'collected_outside_components_short' => 'Autres frais',
    'expected' => 'Attendu',
    'collected' => 'Perçu',
