...
return [
    ...
    'exam_stage_trimester' => 'Examen du trimestre :n',
    'exam_stage_semester' => 'Examen du semestre :n',
    'bulletin_exam_trimester_title' => 'BULLETIN EXAMEN TRIMESTRE :n',
    'bulletin_exam_semester_title' => 'BULLETIN EXAMEN SEMESTRE :n',
    'stage_not_available' => 'Ce bulletin n\'est pas encore disponible. :requested n\'a pas été clôturé officiellement.',
    'stage_not_available_with_latest' => 'Ce bulletin n\'est pas encore disponible (:requested). La dernière étape officielle est :latest.',
    'stage_under_revision' => ':requested est en révision et n\'est pas officiel pour les parents. Le personnel peut encore le consulter.',
    'open_latest_stage' => 'Ouvrir :stage',
    'under_revision_banner' => 'Résultats temporairement en révision.',
    'outstanding_staff_banner' => 'Frais impayés — le bulletin parent n\'est pas libéré tant que le seuil n\'est pas atteint.',
    'reopened_option' => ':label (en révision)',
];
