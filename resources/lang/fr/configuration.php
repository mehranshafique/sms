...
return [
    ...
    'school_whatsapp_qr_title' => 'QR WhatsApp de l\'école (pour les parents)',
    'school_whatsapp_qr_help' => 'Saisissez le numéro WhatsApp que les parents doivent contacter. Téléchargez ou imprimez le QR pour qu\'ils scannent et discutent avec votre école.',
    'school_whatsapp_number' => 'Numéro WhatsApp public',
    'school_whatsapp_number_hint' => 'Chiffres avec indicatif pays (sans +). Utilisé pour le QR / lien wa.me des parents.',
    'school_whatsapp_qr_empty' => 'Saisissez un numéro WhatsApp pour générer le QR.',
    'open_whatsapp' => 'Ouvrir WhatsApp',
    'download_qr' => 'Télécharger le QR',
    'print_qr' => 'Imprimer le QR',
    'school_whatsapp_qr_print_hint' => 'Imprimez et affichez à l\'accueil, au tableau d\'affichage ou sur les quittances.',
