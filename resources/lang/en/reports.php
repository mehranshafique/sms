...
return [
    ...
    'exam_stage_trimester' => 'Trimester :n exam',
    'exam_stage_semester' => 'Semester :n exam',
    'bulletin_exam_trimester_title' => 'TRIMESTER :n EXAM REPORT CARD',
    'bulletin_exam_semester_title' => 'SEMESTER :n EXAM REPORT CARD',
    'stage_not_available' => 'This report is not available yet. :requested has not been officially closed.',
    'stage_not_available_with_latest' => 'This report is not available yet (:requested). The latest official stage is :latest.',
    'stage_under_revision' => ':requested is being revised and is not official for parents. Staff can still view it.',
    'open_latest_stage' => 'Open :stage',
    'under_revision_banner' => 'Results temporarily under revision.',
    'outstanding_staff_banner' => 'Fees outstanding — parent copy is not released until the payment threshold is met.',
    'reopened_option' => ':label (under revision)',
];