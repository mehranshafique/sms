...
return [
    ...
    'kiosk_nfc_listening' => 'NFC on — hold card to the back of the phone',
    'kiosk_nfc_tap_hint' => 'Tap Enable NFC, allow permission, then hold the card to the back of the phone. Status bar should say NFC on before tapping.',
    ...
    'kiosk_nfc_no_data' => 'Card tapped but UID not readable in Chrome. Many school RFID cards need a USB reader or QR — plain UID tags are often blocked by the browser.',
