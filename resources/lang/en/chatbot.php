...
return [
    ...
    */
    ...
    'menu_profile_help' => 'Defines which chatbot menu is shown after the user authenticates.',
    'allowed_roles' => 'Allowed Roles',
    'allowed_roles_help' => 'Leave empty to use default system roles for this menu profile. Select one or more school roles for custom access (e.g. Account, Accountant).',
    'default_roles' => 'Default (system roles)',
    'actions' => 'Actions',
