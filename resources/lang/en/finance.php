...
return [
    ...
    'proportional_allocation' => 'Proportional Fee Allocation',
    'proportional_allocation_enable' => 'Enable proportional fee allocation',
    'proportional_allocation_help' => 'Break a global fee into components (e.g. Tuition, Uniform, Transport). Every payment is then split across the components in proportion to their share of the total.',
    'proportional_allocation_disabled_notice' => 'Proportional fee allocation is currently disabled for this school. Existing breakdowns still apply to payments, but new ones cannot be configured until you enable it in payment settings.',
    'split_into_components' => 'Split this fee into components',
    'component_name' => 'Component',
    'add_component' => 'Add component',
    'share' => 'Share',
    'total' => 'Total',
    'components_must_match_total' => 'The components must add up to the fee amount.',
    'components_min' => 'Add at least :count components, or turn off the proportional split.',
    'components_incomplete' => 'Every component needs a name and an amount greater than zero.',
    'components_sum_mismatch' => 'The components add up to :total but the fee amount is :amount.',
    'unallocated_payment' => 'Unallocated payment',
    'component_report_title' => 'Fee Component Report',
    'component_report_subtitle' => 'How much of every payment was assigned to each fee component.',
    'component_breakdown' => 'Component breakdown',
    'no_components_yet' => 'No fee components have been invoiced yet.',
    'collected_outside_components' => 'Collected on fees without a component breakdown',
    'collected_outside_components_short' => 'Other fees',
    'expected' => 'Expected',
    'collected' => 'Collected',
    'progress' => 'Progress',
