...
return [
    ...
    'school_whatsapp_qr_title' => 'School WhatsApp QR (for parents)',
    'school_whatsapp_qr_help' => 'Enter the WhatsApp number parents should message. Download or print the QR so parents can scan and chat with your school.',
    'school_whatsapp_number' => 'Public WhatsApp number',
    'school_whatsapp_number_hint' => 'Digits with country code (no +). Used for the parent QR / wa.me link — separate from gateway credentials if needed.',
    'school_whatsapp_qr_empty' => 'Enter a WhatsApp number to generate the QR.',
    'open_whatsapp' => 'Open WhatsApp chat',
    'download_qr' => 'Download QR',
    'print_qr' => 'Print QR',
    'school_whatsapp_qr_print_hint' => 'Print and display at reception, on notice boards, or fee receipts.',
