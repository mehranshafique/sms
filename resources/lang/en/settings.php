...
return [
    ...
    'grading_scale' => 'Exam mark grades',
    'grading_scale_help' => 'Used when entering and printing exam marks (award lists). Maps a subject percentage to a letter grade (e.g. A+, B).',
    ...
    'block_reports_on_debt_help' => 'If enabled, report cards are blocked when the student has not reached the minimum paid amount for that academic stage (Chatbot, SMS/WhatsApp, and web downloads). Stages with no minimum stay open.',
    'report_min_paid_title' => 'Minimum paid amount per report period',
    'report_min_paid_help' => 'For each period or exam stage, set how much the student must have paid (current session) to unlock that report card. Leave blank to allow access for that stage regardless of outstanding balance. The parent sees how much remains to reach this amount.',
    ...
    'report_authority_title' => 'Report card authorities by cycle',
    'report_authority_help' => 'Configure who signs primary and secondary report cards. The correct title, name, and signature are chosen automatically from the student’s education cycle.',
    'report_authority_primary' => 'Primary (Director)',
    'report_authority_secondary' => 'Secondary (Prefect)',
    'report_authority_role_title' => 'Title on report',
    'report_authority_name' => 'Full name',
    'report_authority_name_placeholder' => 'e.g. MOUTARD MBENGA',
    'report_authority_signature' => 'Handwritten signature image',
    'remove_report_authority_signature' => 'Remove signature image',
    'seal_left' => 'Left',
    'seal_center' => 'Center',
    'seal_right' => 'Right',
    'seal_none' => 'Hidden',
    'application_scale' => 'Bulletin Application grades',
    'application_scale_help' => 'Used only on report cards for the Application column. Maps the student’s overall percentage to a letter (e.g. A, B, AB, C). Separate from exam mark grades above.',
