...
class TemplateVariableRegistry
{
    ...
    private static function definitions(): array
    {
        ...
        self::$definitions = [
            ...
            'request_submitted' => 'StudentName, RequestType, TicketNumber, SchoolName',
            'request_submitted_parent' => 'StudentName, TicketNumber, RequestType, ResponseTime, SchoolName',
            ...
            'fund_request_submitted' => 'Requester, Title, Amount, SchoolName',
            'fund_request_processed' => 'Title, Status, SchoolName, Amount',
