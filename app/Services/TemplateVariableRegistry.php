...
class TemplateVariableRegistry
{
    ...
    private static function definitions(): array
    {
        ...
        self::$definitions = [
            ...
            'student_welcome' => 'Name, Class, SchoolName, Email, Url, Shortcode, LoginId, Username, Password',
            ...
            'resit_notification' => 'ParentName, StudentName, ClassName, ResitSubjects, Decision, Status, SchoolName, AcademicYear',
            ...
            'homework_published' => 'ParentName, StudentName, Title, Subject, ClassName, Deadline, SchoolName',
            ...
            'reenrollment_partial_confirmation' => 'ParentName, StudentName, Class, Status, AmountRequired, AmountPaid, Remaining, SchoolName',
            'reenrollment_confirmed' => 'ParentName, StudentName, Class, Session, Campaign, SchoolName',
            'reenrollment_declined' => 'ParentName, StudentName, Class, SchoolName',
            'reenrollment_rejected' => 'ParentName, StudentName, Class, SchoolName',
            'pre_enrollment_received' => 'ParentName, StudentName, TemporaryId, Class, Option, Status, SchoolName',
            'pre_enrollment_test_invite' => 'ParentName, StudentName, TemporaryId, TestDate, TestLocation, SchoolName',
            'pre_enrollment_test_reminder' => 'ParentName, StudentName, TemporaryId, TestDate, TestLocation, SchoolName',
            'pre_enrollment_admitted' => 'ParentName, StudentName, TemporaryId, TestScore, SchoolName',
            'pre_enrollment_not_admitted' => 'ParentName, StudentName, TemporaryId, TestScore, SchoolName',
            'pre_enrollment_finalize_invite' => 'ParentName, StudentName, TemporaryId, SchoolName',
            'pre_enrollment_finalized' => 'ParentName, StudentName, TemporaryId, AdmissionNumber, Class, SchoolName',
