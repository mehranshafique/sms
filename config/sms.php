...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Default WhatsApp Driver (fallback when no global DB setting)
    |--------------------------------------------------------------------------
    */
    'whatsapp_default' => env('WHATSAPP_DRIVER', 'meta'),

    /*
    |--------------------------------------------------------------------------
    | Default country calling code (DRC) for WhatsApp MSISDN normalization
    |--------------------------------------------------------------------------
    */
    'default_country_code' => env('SMS_DEFAULT_COUNTRY_CODE', '243'),
