...
Thank you, $SchoolName.',
            ...
            [
                ...
                'body' => 'Dear $ParentName, $StudentName ($ClassName): $Decision. Subjects: $ResitSubjects. — $SchoolName ($AcademicYear)',
                'available_tags' => '$ParentName, $StudentName, $ClassName, $ResitSubjects, $Decision, $Status, $SchoolName, $AcademicYear',
                'is_active' => true,
            ],
            [
